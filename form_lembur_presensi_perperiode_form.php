						...
						<div class="box1">						
							<div class="row">
								...
								<div class="col-md-8" style="text-align:left">
								 	<input type="hidden" name="nip" id="nip" placeholder="cari berdasarkan penggalan NIP/NUP atau penggalan Nama" class="form-control" value="<?=$_SESSION['user_nip']?>"/>
									<div class="row">
...
<div class="row">
	...
	<div class="col-md-10" id="data"></div>
	<div class="col-md-1"></div>
</div>
